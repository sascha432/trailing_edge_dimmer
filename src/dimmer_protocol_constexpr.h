...
static constexpr size_t __DIMMER_REGISTER_CUBIC_INT_DATAX(n) = DIMMER_REGISTER_CUBIC_INT_DATAX(n);
static constexpr size_t __DIMMER_REGISTER_CUBIC_INT_DATAY(n) = DIMMER_REGISTER_CUBIC_INT_DATAY(n);
