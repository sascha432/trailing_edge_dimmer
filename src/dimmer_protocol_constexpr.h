...
static constexpr size_t __DIMMER_CHANNEL_ON_OFF = DIMMER_CHANNEL_ON_OFF;
...
static constexpr size_t __DIMMER_COMMAND_WRITE_CFG_NOW = DIMMER_COMMAND_WRITE_CFG_NOW;
...
static constexpr size_t __DIMMER_OPTIONS_REPORT_METRICS = DIMMER_OPTIONS_REPORT_METRICS;
