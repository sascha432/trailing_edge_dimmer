...
static constexpr size_t __DIMMER_COMMAND_GET_CFG_LEN = DIMMER_COMMAND_GET_CFG_LEN;
...
static constexpr size_t __DIMMER_EEPROM_EVT_CF_UPDATED = DIMMER_EEPROM_EVT_CF_UPDATED;
