    ...
    if (Serial.available()) {
        ...
        switch(input) {
            ...
            case 'l':
                ...
                read_timing(DIMMER_TIMINGS_MIN_OFF_TIME_IN_US,   F("Adjust halfwave time in us:  "));
                break;
            ...
            case '*':
                level = get_level(selected_channel);
                if (level != -1) {
                    set_level(selected_channel, level + max(1, dimmer_get_max_level() / 100));
                }
                break;
            case '/':
                level = get_level(selected_channel);
            ...
            case '0':
                ...
                break;
            case ',':
                set_level(selected_channel, dimmer_get_max_level());
                break;
            ...
            case '8':
            case '9':
                fade(selected_channel, (input - '1') * 0.125 * dimmer_get_max_level(), 5.0);
                break;
        }
    }
}
