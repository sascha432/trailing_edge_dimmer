...
# .\scripts\trans_cmd.py -O compile ".\scripts\trans_cmd_cfg_struct.json" -DDIMMER_CUBIC_INTERPOLATION=1 -D DIMMER_CUBIC_INT_TABLE_SIZE=8 -D SERIALTWOWIRE_MAX_INPUT_LENGTH=0xff -D DEBUG=1 -C "gcc %SRC% -o %EXE%"
...
dimmer = dimmer_const.DimmerConst()
