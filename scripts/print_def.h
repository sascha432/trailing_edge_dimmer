...
Serial.print(F("#define DIMMER_COMMAND_WRITE_CFG_NOW             ")); Serial.printf("0x%02x\n", (uint8_t)DIMMER_COMMAND_WRITE_CFG_NOW);
...
Serial.print(F("#define DIMMER_OPTIONS_REPORT_METRICS            ")); Serial.printf("0x%02x\n", (uint8_t)DIMMER_OPTIONS_REPORT_METRICS);
